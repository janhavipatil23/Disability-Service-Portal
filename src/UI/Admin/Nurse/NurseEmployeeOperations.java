 ...
 * @author janhavi
 */
public class NurseEmployeeOperations extends javax.swing.JPanel {

    /**
     * Creates new form NurseEmployeeOperations
     */
    EcoSystem system;
    NursingOrganization org;
    DefaultTableModel model;
    public NurseEmployeeOperations(EcoSystem system, NursingOrganization organization) {
        initComponents();
        org = organization;
        this.system = system;
        ...
        for(int i=0;i<organization.getNurseEmployeeList().size();i++){
            model.addRow(new Object[]{
                organization.getNurseEmployeeList().get(i).getEmployee().getId(),
                organization.getNurseEmployeeList().get(i).getEmployee().getName()
            });
        }
    }
    ...
    private void initComponents() {
        ...
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 150, -1, 23));
        ...
        add(Create, new org.netbeans.lib.awtextra.AbsoluteConstraints(152, 237, 150, 33));

        jLabel9.setFont(new java.awt.Font("STSong", 0, 18)); // NOI18N
        jLabel9.setText("Name:");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 190, 112, 23));

        jLabel10.setFont(new java.awt.Font("STSong", 0, 24)); // NOI18N
        jLabel10.setText("Update Employee");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 290, 220, 23));
        ...
        add(Update, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 427, 150, 33));
        ...
        add(Delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 490, 150, 33));
    ...
    private void CreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateActionPerformed
        ...
        UserAccount newUser = system.getUserAccountDirectory().createUserAccount(empName,empName, newEmployee, new NurseRole("employee"));
        org.getUserAccountDirectory().getUserAccountList().add(newUser);
        org.getNurseEmployeeList().add(newUser);
        JOptionPane.showMessageDialog(null, "EMPLOYEE CREATE SUCCESSFULLY");
            model.addRow(new Object[]{
                newEmployee.getId(),
                newEmployee.getName()
            });
    ...
    private void showEmployeeList() {
        for(int i=0;i<org.getNurseEmployeeList().size();i++){
            model.addRow(new Object[]{
                org.getNurseEmployeeList().get(i).getEmployee().getId(),
                org.getNurseEmployeeList().get(i).getEmployee().getName()
            });
        }
    }
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        ...
        if(jTable1.getSelectedRow() >=0){
            ...
            for(int i=0;i<org.getNurseEmployeeList().size();i++){
                if(org.getNurseEmployeeList().get(i).getEmployee().getId() == Integer.parseInt(idUpdate.getText())){
                    org.getNurseEmployeeList().get(i).getEmployee().setName(nameUpdate.getText());
                }
            }
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        if(jTable1.getSelectedRow() >=0){
            ...
            ArrayList<UserAccount> employeeList = org.getNurseEmployeeList();
            for(int i=0;i<employeeList.size();i++){
                if(employeeList.get(i).getEmployee().getId() == Integer.parseInt(idUpdate.getText())){
