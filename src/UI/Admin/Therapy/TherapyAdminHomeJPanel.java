 ...
 * @author snehalchavan
 */
public class TherapyAdminHomeJPanel extends javax.swing.JPanel {

    /**
     * Creates new form TherapyAdminHomeJPanel
     */
    private JPanel userProcessContainer;
    private EcoSystem system;
    UserAccount userAccount;
    JSplitPane adminSplitPane;
    TherapyOrganization organization;

    TherapyAdminHomeJPanel(JPanel userProcessContainer, UserAccount userAccount, EcoSystem system, TherapyOrganization organization,JSplitPane adminSplitPane, Icon img) {
        initComponents();
